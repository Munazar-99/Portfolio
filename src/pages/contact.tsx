...
const Contact = () => {
    ...
    return (
        <>
            ...
            <TransitionEffect/>
            <main className='flex w-full h-screen  flex-wrap p-24 pt-16 md:p-2 md:pt-6   md:justify-center md:items-center lg:p-10 '>
                <section className=' flex h-[550px] w-1/2 dark:bg-dark bg-light md:hidden lg:h-[400px] lg:mt-8 '>
               
                    <ContactSvg styling='h-full w-full '/>
                    </section>
                
                <section className='flex flex-col w-1/2 z-0  p-8 pt-3 max-h-full md:w-full md:p-0 md:px-3 md:pt-[3px] md:items-center lg:p-4 lg:pt-0'>
                <AnimatedText text='Get In Touch!' className='mb-16 !text-[4rem] lg:!text-[2.7rem]  md:!text-4xl md:mb-8 lg:mb-10' />
